...
- Repo: https://github.com/yourusername/quantmind
- QuantMind is a CLI-based AI agent for deep financial research, built with TypeScript, Ink (React for CLI), and LangChain.
...
- Config: `.quantmind/settings.json` (persisted model/provider selection)
...
- Config stored in `.quantmind/settings.json` (gitignored).
